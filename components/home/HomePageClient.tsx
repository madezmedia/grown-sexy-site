...
import { HomepageSettings } from '@/lib/homepage'

interface HomePageProps {
  settings: HomepageSettings;
}

export default function HomePageClient({ settings }: HomePageProps) {
              ...
              {[
                {
                  ...
                  description: settings.card1Description,
                ...
                },
                {
                  ...
                  description: settings.card2Description,
                ...
                },
                {
                  ...
                  description: settings.card3Description,
